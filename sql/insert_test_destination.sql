-- =============================================
-- Création d'une destination de test avec photo
-- À exécuter dans phpMyAdmin
-- =============================================

USE kica7829_voyages;

-- Insérer une destination de test
...
-- Afficher l'ID de la destination créée
SELECT LAST_INSERT_ID() as destination_id;

-- Afficher toutes les destinations
SELECT id, code_oaci, nom, ville, photo_principale, created_at 
FROM destinations 
ORDER BY id DESC 
LIMIT 10;
